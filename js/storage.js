...
const DEFAULTS = () => ({
  ...
  lobster: { days: 14, startPots: 5, startCash: 0, printCount: 8, physicalDice: false, skillGame: false, lottoPrize: 100, schedule: null, schedVer: 2, ledger: [], demo: null, scoreboard: [] },
  scoring: {
