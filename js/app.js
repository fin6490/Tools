...
import * as store from "./storage.js?v=20260916h";
import { Wheel, parseEntries, parseLine } from "./wheel.js?v=20260916h";
import * as sound from "./sound.js?v=20260916h";
import { burst } from "./confetti.js?v=20260916h";
import { initTimer } from "./timer.js?v=20260916h";
import { initCounters } from "./counter.js?v=20260916h";
import { initGroups } from "./groups.js?v=20260916h";
import { initImages } from "./images.js?v=20260916h";
import { initScores } from "./scores.js?v=20260916h";
import { initSlots } from "./slots.js?v=20260916h";
import { initNumbers } from "./numbers.js?v=20260916h";
import { initDice } from "./dice.js?v=20260916h";
import { initFirstPlayer } from "./firstplayer.js?v=20260916h";
import { initScorepad } from "./scorepad.js?v=20260916h";
import { initChessClock } from "./chessclock.js?v=20260916h";
import { initBracket } from "./bracket.js?v=20260916h";
import { initDojo } from "./dojo.js?v=20260916h";
import { initReveal } from "./reveal.js?v=20260916h";
import { initPairs } from "./pairs.js?v=20260916h";
import { initBingo } from "./bingo.js?v=20260916h";
import { initClassQuiz } from "./classquiz.js?v=20260916h";
import { initGridClaim } from "./gridclaim.js?v=20260916h";
import { initCountdown } from "./countdown.js?v=20260916h";
import { initAxiom } from "./axiom.js?v=20260916h";
import { initHangman } from "./hangman.js?v=20260916h";
import { initNoughts } from "./noughts.js?v=20260916h";
import { initLexicon } from "./lexicon.js?v=20260916h";
import { initNumberwang } from "./numberwang.js?v=20260916h";
import { initPirates } from "./pirates.js?v=20260916h";
import { initLobster } from "./lobster.js?v=20260916h";
import { initSupport } from "./support.js?v=20260916h";
import { ROUTES } from "./routes.js?v=20260916h";
