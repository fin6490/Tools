...
import * as store from "./storage.js?v=20260916e";
import { Wheel, parseEntries, parseLine } from "./wheel.js?v=20260916e";
import * as sound from "./sound.js?v=20260916e";
import { burst } from "./confetti.js?v=20260916e";
import { initTimer } from "./timer.js?v=20260916e";
import { initCounters } from "./counter.js?v=20260916e";
import { initGroups } from "./groups.js?v=20260916e";
import { initImages } from "./images.js?v=20260916e";
import { initScores } from "./scores.js?v=20260916e";
import { initSlots } from "./slots.js?v=20260916e";
import { initNumbers } from "./numbers.js?v=20260916e";
import { initDice } from "./dice.js?v=20260916e";
import { initFirstPlayer } from "./firstplayer.js?v=20260916e";
import { initScorepad } from "./scorepad.js?v=20260916e";
import { initChessClock } from "./chessclock.js?v=20260916e";
import { initBracket } from "./bracket.js?v=20260916e";
import { initDojo } from "./dojo.js?v=20260916e";
import { initReveal } from "./reveal.js?v=20260916e";
import { initPairs } from "./pairs.js?v=20260916e";
import { initBingo } from "./bingo.js?v=20260916e";
import { initClassQuiz } from "./classquiz.js?v=20260916e";
import { initGridClaim } from "./gridclaim.js?v=20260916e";
import { initCountdown } from "./countdown.js?v=20260916e";
import { initAxiom } from "./axiom.js?v=20260916e";
import { initHangman } from "./hangman.js?v=20260916e";
import { initNoughts } from "./noughts.js?v=20260916e";
import { initLexicon } from "./lexicon.js?v=20260916e";
import { initNumberwang } from "./numberwang.js?v=20260916e";
import { initPirates } from "./pirates.js?v=20260916e";
import { initLobster } from "./lobster.js?v=20260916e";
import { initSupport } from "./support.js?v=20260916e";
import { ROUTES } from "./routes.js?v=20260916e";
